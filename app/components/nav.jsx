    ...
    <>
      <style>{`
        .dn-nav-link {
          ...
          font-family: ${HEADING}; font-size: 12px; font-weight: 500;
          letter-spacing: 0.16em; text-transform: uppercase;
          color: rgba(244,237,217,0.45); transition: color 0.25s;
          padding-bottom: 3px;
        }
        .dn-nav-link::after {
          content: ''; position: absolute; bottom: 0; left: 0; right: 0;
          height: 1px; background: linear-gradient(90deg, ${SAND}, ${SAND}80);
          transform: scaleX(0); transform-origin: left;
          transition: transform 0.3s ease;
        }
        .dn-nav-link:hover, .dn-nav-link.dn-active { color: ${CREAM}; }
        .dn-nav-link:hover::after, .dn-nav-link.dn-active::after { transform: scaleX(1); }
      `}</style>
      ...
      <motion.nav
        ...
        style={{
          ...
          background: scrolled ? "rgba(14,12,8,0.94)" : "transparent",
          backdropFilter: scrolled ? "blur(16px)" : "none",
          borderBottom: scrolled ? `1px solid rgba(200,160,92,0.15)` : "1px solid transparent",
          transition: "all 0.4s ease",
        }}
      >
        <div className="dn-nav-inner" style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 2rem", height: "72px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>

          {/* Logo */}
          <a href="#about" onClick={(e) => go(e, "#about")} style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: "12px" }}>
            <div style={{ width: "10px", height: "10px", background: SAND, transform: "rotate(45deg)", flexShrink: 0 }} />
            <span style={{ fontFamily: DISPLAY, fontSize: "22px", fontWeight: 500, letterSpacing: "0.06em", color: CREAM, fontStyle: "italic" }}>
          ...
          <div className="dn-desktop-links">
            {activeLinks.map((link) => (
              <a key={link.href} href={link.href} onClick={(e) => go(e, link.href)}
                className={`dn-nav-link${active === link.href.replace("#", "") ? " dn-active" : ""}`}>
                {link.label}
              </a>
            ))}
            {resumeHref && (
              <a href={resumeHref} download="Resume.pdf"
                style={{
                  ...
                  border: `1px solid rgba(200,160,92,0.35)`,
                ...
                onMouseLeave={(e) => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.borderColor = "rgba(200,160,92,0.35)"; }}
              >
          ...
          {/* Mobile hamburger */}
          <button className="dn-hamburger" onClick={() => setMobileOpen(!mobileOpen)}
        ...
        {/* Mobile drawer — pure React state, no CSS class toggling */}
        <div style={{ display: mobileOpen ? "block" : "none" }}>
          <div style={{ background: "rgba(14,12,8,0.98)", borderBottom: `1px solid rgba(200,160,92,0.12)`, padding: "1.5rem 1.25rem 2rem" }}>
              ...
              return (
                <a key={link.href} href={link.href} onClick={(e) => go(e, link.href)}
                  style={{
                    ...
                    borderBottom: i < activeLinks.length - 1 ? "1px solid rgba(244,237,217,0.06)" : "none",
                    ...
                    color: isActive ? SAND : "rgba(244,237,217,0.5)", textDecoration: "none",
            ...
            {resumeHref && (
              <a href={resumeHref} download="Resume.pdf"
                style={{
                  ...
                  letterSpacing: "0.18em", textTransform: "uppercase",
                  color: SAND, textDecoration: "none",
                  border: `1px solid rgba(200,160,92,0.3)`, padding: "10px 20px",
                  background: "rgba(200,160,92,0.04)",
                }}
              >
